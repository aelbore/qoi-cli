...
import { Options, transformSync, minifySync, JsMinifyOptions } from '@swc/core'
  ...
  return {
    ...
    renderChunk(code: string) {
      return options?.minify 
        ? minifySync(code, {
          sourceMap: (typeof opts.sourceMaps == 'string') ? true: opts.sourceMaps, 
          ...({ compress: true, mangle: { toplevel: true } } as JsMinifyOptions),  
        })
        : null
    }
  } as Plugin
